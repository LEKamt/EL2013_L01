...
HD_PWD='C:/Users/luisk/OneDrive/Documentos/2024-II/Circuitos digitales/Laboratorio_1/Practica_Reto/Practica_Reto.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exp03.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exp03.tcl
